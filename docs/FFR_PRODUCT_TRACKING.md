...
**Edition:** 2026-08-09 (RFSN-054A Preview)  
...
| Area | Status | Notes |
| --- | --- | --- |
| Production | 🟢 Stable | deploy `803d531b` · Git `2db9b77` · `buildTime=2026-08-09T06:02:41.032Z` · 051A–D + **054** + 052J/K · **054A promoting** |
| Preview | 🟢 Git-aligned | Git `fa65ab5` · deploy `3bdcd8f3` · `buildTime=2026-08-09T07:27:48.537Z` · 051A–D + **054** + **054A** + 052J/K |
...
| UI density | 🟢 Production + 054A Preview | **RFSN-054** live both envs. **054A** compact Live Draft Control live Preview. |
...
| **Preview** | `https://sprint-8-preview.fantasyfootballrivals.com` | env `sprint-8-preview` · service `espn-fantasy-gm-tool` `55c68659-ee4c-4352-98f7-4fff0e4aad87` | `feature/provider-expansion` | Git **`fa65ab5`**. Railway deploy `3bdcd8f3` (Git, not CLI). Health `buildTime=2026-08-09T07:27:48.537Z` (gitSha still stale `dff6154`) |
...
| Layer | State |
| --- | --- |
| Production | Git **`2db9b77`** includes 052 A–K + **051A–D** + **054**. Live `buildTime=2026-08-09T06:02:41.032Z` (deploy `803d531b`). |
| Preview | Same stack + **054A**. Git tip **`fa65ab5`** via Git deploy `3bdcd8f3`. |
...
Shipped and live on `www.fantasyfootballrivals.com` (git `2db9b77` / buildTime `2026-08-09T06:02:41.032Z` / deploy `803d531b`).
...
051A–D typography **and RFSN-054 density** are Production.
...
| **054A** Compact Live Draft Control | **Live Preview** | `fa65ab5` / `3bdcd8f3`. Production cherry-pick this increment. |
...
| **054A** | Compact Live Draft Control (`/rfsn/live` + `/draft/live`) | **Preview live** `fa65ab5` / `3bdcd8f3`. Production cherry-pick. |
