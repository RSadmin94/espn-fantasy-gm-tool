...
export const PRODUCT_FEATURE_CATALOG: ProductFeatureCatalogEntry[] = [
  ...
  { id: "post-draft-evaluation", label: "Post-Draft Evaluation", entryType: "route", route: "/post-draft-evaluation", aiFeatureId: "POST_DRAFT_STORYTELLING" },
...
export function productFeatureIdForAiFeature(aiFeatureId: string | null | undefined): string | null {
  ...
  if (aiFeatureId === "POST_DRAFT_EVALUATION" || aiFeatureId === "POST_DRAFT_STORYTELLING") {
    return "post-draft-evaluation";
  }
