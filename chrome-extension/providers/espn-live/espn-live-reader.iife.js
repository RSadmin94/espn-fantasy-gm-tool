"use strict";
(() => {
  // src/draft-monitor/normalize/draftTypes.ts
  var MONITOR_VERSION = "1.3.1-standalone";

  // src/draft-monitor/normalize/eventKey.ts
  function normName(s) {
  ...
  // src/draft-monitor/normalize/pickOwnership.ts
  ...
  // src/draft-monitor/adapters/espnAdapter.ts
  ...
  // src/draft-monitor/adapters/fantasyProsAdapter.ts
  ...
  // src/draft-monitor/normalize/mergeSnapshot.ts
  function mergePicks(existing2, incoming) {
    const byKey = /* @__PURE__ */ new Map();
    const softToKey = /* @__PURE__ */ new Map();
    let duplicatesSuppressed = 0;
    for (const p of existing2) {
  ...
  // src/draft-monitor/board/boardStyles.ts
  var BOARD_STYLES = `
.dbm-root {
...
`;
  ...
  // src/draft-monitor/board/renderBoard.ts
  ...
  // src/draft-monitor/board/DraftBoardMonitor.ts
  ...
  // src/draft-monitor/runtime/detectSource.ts
  ...
  var ESPN_LIVE_READER_CAPABILITIES = ["pick_batch", "replay", "dormant_until_arm"];
  ...
  function armLeagueMatchesPage(args) {
  ...
  var _EspnBookmarkletPublisher = class _EspnBookmarkletPublisher {
    ...
    arm(rawConfig) {
      ...
      const pageLeagueId = raw.pageLeagueId != null ? String(raw.pageLeagueId).trim() : this.readPageLeagueIdHint();
  ...
  // src/draft-monitor/autoInjectEntry.ts
  var ESPN_LIVE_READER_VERSION2 = "1.0.0";
  var ESPN_LIVE_READER_KIND = "espn-live-reader";
  function installHandshake(lifecycle) {
    try {
      window.__RFSN_ESPN_LIVE_READER__ = {
        kind: ESPN_LIVE_READER_KIND,
        readerVersion: ESPN_LIVE_READER_VERSION2,
        protocolVersion: ESPN_BM_PROTOCOL_VERSION,
        lifecycle,
  ...
  var api = {
    ...
    version: ESPN_LIVE_READER_VERSION2
  };
  try {
  ...
  var existing = window.__RFSN_ESPN_LIVE_READER__;
  if (existing && existing.kind === ESPN_LIVE_READER_KIND && existing.readerVersion === ESPN_LIVE_READER_VERSION2 && Number(existing.protocolVersion) === ESPN_BM_PROTOCOL_VERSION) {
    ...
    startDraftBoardMonitor({ preferPopup: false, pollMs: 1e3 });
