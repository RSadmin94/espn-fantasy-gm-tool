...
export function ownerProfilesLensCopy(mode: OwnerProfilesMode) {
  if (mode === "self") {
    return {
      ...
      historicalRivalLabel: "Greatest historical rivalry",
      currentRivalLabel: "Current biggest rivalry",
      toughestLabel: "Toughest active H2H",
      ...
      currentRivalEmpty: "No active rival established yet.",
      toughestEmpty: "No tough H2H profile among active owners yet.",
      historicalRetiredCue: "Retired from league",
      historicalActiveCue: "Active owner",
  ...
  return {
    ...
    historicalRivalLabel: "Greatest historical rival",
    currentRivalLabel: "Current biggest rival",
