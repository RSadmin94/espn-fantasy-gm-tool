...
export function RfsnCommentaryLog({ entries, className }: RfsnCommentaryLogProps) {
  if (entries.length === 0) {
    return (
      ...
      >
        <p className="text-[10px] font-black uppercase tracking-wider text-white/35">Running log</p>
  ...
  return (
    ...
    >
      <p className="mb-1.5 text-[10px] font-black uppercase tracking-wider text-white/45">Running log</p>
