...
export const gmTransactions = mysqlTable(
  "transactions",
  {
    ...
    teamId: int("teamId"),
    itemType: varchar("itemType", { length: 32 }),
    position: varchar("position", { length: 16 }),
    round: int("round"),
    pickInRound: int("pickInRound"),
    overallPickNumber: int("overallPickNumber"),
    pickSeason: int("pickSeason"),
    legIndex: int("legIndex").notNull().default(0),
...
export const usageEvents = mysqlTable(
  "usage_events",
  {
    ...
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    // AI usage attribution (null/default on older rows)
